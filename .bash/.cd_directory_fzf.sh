cd /var/log/pw-share/pods/stack/                  # shared dir
cd /var/log/pw-share/pods/stack/cunode01/         # from oam to cu shared dir
cd /var/log/pw-share/pods/stack/cunode01/nrlogs/  # from oam to cu shared dir
cd /var/log/pw-share/pods/stack/cunode01/prvt/    # from oam to cu shared dir
cd /var/log/pw-share/pods/stack/dunode02/         # from oam to du shared dir
cd /var/log/pw-share/pods/stack/dunode02/nrlogs/  # from oam to du shared dir
cd /var/log/pw-share/pods/stack/dunode02/prvt/    # from oam to du shared dir
cd ~/.config/.bash/                               # bash dir
...
cd /var/log/pw-share/pods/stack/vnode01   # 4g shared logs dir
